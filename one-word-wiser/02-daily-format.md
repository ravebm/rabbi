...
The week has a shape. Readers should be able to feel what day it is from the post.
...
## SATURDAY EVENING — "Havdalah: The Week in Five Words"

Free. 200–300 words. Havdalah is the ceremony that ends Shabbat — a candle, wine, spices, and a blessing that separates the holy day from the week. Perfect frame for a recap.
...
## SUNDAY MORNING — "Your Verse"

Free. 250–350 words. A reader sends a verse — any verse — and Evan shows the Hebrew underneath. HfC's "The Verses You Asked For" is their highest-engagement series; ours runs every Sunday.

- Open with the reader's first name and state ("Linda in Ohio asked about Psalm 46:10…"). Permission implied by sending; say so on the About page.
- Same anatomy as a morning post, but the word is chosen by the verse.
- Close with: "Send me a verse. Just reply to this email." Every reply is a future post and a relationship.
- Keep a queue in `05-production-workflow.md` → *Verse Queue*.

## SUNDAY EVENING — "The Week Ahead"

Free. 150–250 words. The theme for the coming week, why now (calendar, season, holiday), and the five words listed. One sentence each. Ends: "Monday morning: *bereshit*, in the beginning. See you at sunrise."

This post exists to make Monday morning's open rate higher. It's the trailer.
