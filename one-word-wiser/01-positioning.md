...
**Keep "One Word Wiser."** It's already live on rabbi.substack.com and it's good:

- It states the promise in three words. Every post makes you exactly that.
- It's not denominational. A Christian, a Jew, and a seeker can all subscribe without feeling like a guest.
- It's ownable. Nobody else has it. "Hebrew for Christians" is shared by at least three publications (Yehonatan's Substack, John Parsons's hebrew4christians.com, and a Substack of the same name) — a crowded name is a leaky bucket.
- It's a series title, not a course title. "Wiser" is a direction, not a destination — it sustains a daily habit.

**The one weakness:** the name doesn't contain the search words *Hebrew* or *Bible*. The tagline and the About page have to carry them. See below.

Alternates, in case you want to test one against it in the Facebook ad (only the headline changes):

| Name | Why it might work | Why I'd still pick OWW |
|---|---|---|
| *The Hebrew Behind the Bible* | Pure search intent; explains itself in the ad | Generic; feels like a reference book, not a relationship |
| *Root Words* | Hebrew is a root-based language; double meaning (roots of faith) | Too small; sounds like a linguistics blog |
| *First Words* | The Bible's first language; Genesis 1 | Could be about babies |
| *The Rabbi's Lexicon* | Leans on your credibility | "Lexicon" is cold |

## The tagline

Current: *One Hebrew word, one rabbinic teaching, and one wiser way to live.*

**Keep it.** It does three jobs: it contains "Hebrew," it announces the rabbi, and — this matters — it is literally the structure of every day's posts *and* the free/paid line (word: free · teaching: free · wiser way: paid). A tagline that is also the product architecture is rare. Don't touch it.
...
Why it works: the first sentence is the hook and shows first on Substack's discover page; "Genesis to the Gospels" signals both testaments without naming Jesus; the cadence is deliberately left out — readers find it on day one, and it belongs in the paid pitch, not the public line; "No Hebrew required" removes the one objection that stops people subscribing. Don't add "discover," "wisdom," or "journey" to it.
...
> For Christians who love the Bible but read it in translation, *One Word Wiser* is the daily letter from a rabbi that teaches one Hebrew word a day, with the rabbinic tradition behind it and the place Jesus used it, and on Shabbat the word from the portion every synagogue is reading that morning, so that the verses you have read your whole life open up. Unlike *Hebrew for Christians*, it comes from a bestselling author and working rabbi who has spent twenty years teaching Judaism to churches, and it goes past vocabulary into what the sages saw in the word.

## Why you win this lane
...
6. **The Shabbat window.** Every Saturday, the word from the Torah portion read in every synagogue in the world that morning. It costs nothing (it's the sermon Evan is already writing) and no one else in this lane can offer it. Over a year it becomes a product of its own: the Torah in a year, one word a day, with a rabbi.

## Voice rules for this publication

Carried over from the pulpit voice, adapted for the inbox:

- **Short declaratives. Fragments welcome.** "Soft. Open. It ends with a breath."
...
- **Translation policy.** Every verse is quoted from the NIV, Hebrew Bible and New Testament alike, then one line names the Hebrew under the English ("The word under 'return' is *shuvah*"), then the transliterated Hebrew phrase with the word bolded. No "my translation." When the NIV's wording hides the word, that gap is the teaching; say it plainly ("the English says *repent*"). Never mix translations inside one post.
- **No hedging about theology.** Where a verse is read two ways, name both in one sentence and move on, without sorting the readers into camps: "It's easy to hear X here. The text was Y. Hold both." Never "Christians hear… the rabbis heard…"
- **No us and them.** Never sort the reader and the writer into two groups: not "a Jew says," not "your church," not "where you already say it." Describe the practice, not the people: "in Jewish prayer," "in every synagogue," "still said in Hebrew today." The Gospel or New Testament line is labeled *Other mentions*.
- **One idea per post.** If the secret wants two teachings, save one.
- **The letters and the numbers: wonder, as the tradition's play.** The register is Lawrence Kushner's *Book of Letters* and Daniel Lapin's *Buried Treasure* — each letter a shape with a story, each root a family of meanings, a Hebrew word as how God's language sees the thing. State the tradition's claims as the tradition's ("the rabbis said God created the world with these letters" — Berakhot 55a on Bezalel; Bereshit Rabbah on the *bet*), never as Evan's own fact-claims. Gematria the rabbis made (*sulam* and *Sinai*, both 130, Bereshit Rabbah 68:12; *nachash* and *mashiach*, both 358), acronyms they read (*mizbeach*, Ketubot 10b), enlarged and dotted letters, re-vowellings (*banim* / *bonim*): all welcome in the secret, told as their reading, sourced, with delight, and never offered as proof. Readers love them; the bank marks which ones are classical and which are later plays, and the post says so too. A root picture is a device, not a requirement; never force an etymology to get one.
