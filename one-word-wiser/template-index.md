...
| Rabbi’s Notes | `study-companion/template.json`; `study-companion/selichah-2026-09-16.json`; `study-companion/build.py` | September 15 revised format: one central verse with four substantial commentary excerpts; explanation, a related teaching, questions and further reading on the reverse. Two-page PDF; paid offer remains a proposal |
