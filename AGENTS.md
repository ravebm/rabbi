...
| `one-word-wiser/study-companion/README.md` | Study-sheet standard: Kushner/Olitzky chapters are the approved editorial model; September 16 paid-sheet delivery configured; see its dated delivery record | Everyone |
...
- **Study-sheet writers:** read `one-word-wiser/study-companion/README.md`. Evan’s September 15 direction makes the chapters of Kushner and Olitzky’s *Sparks Beneath the Surface* the model for the whole series: a central biblical text, substantial traditional commentary, accessible explanation, context, and related teachings. Begin with a recognizable human concern and an intriguing, immediately understandable title; Evan rejected “forgiveness leading to reverence” as too abstract. Preserve the reasoning and differences of real sources; do not reduce the format to miniature inspirational summaries. The September 16 pilot offer and welcome delivery are approved and configured; see `one-word-wiser/study-companion/delivery-2026-09-16.md`. Future publishing and cadence remain separate decisions.
...
- The daily word and its meaning in Scripture are free, forever. The current paid benefit is the full weekday reflection on Hebrew, Jewish wisdom, and everyday life, in the same email. Evan’s September 14 decision starts paid weekday continuations on September 15, 2026, after a complete free teaching. This supersedes the prior September 27 launch end. Never gate Shabbat or Sunday. September 16 exception: Evan approved a complete free letter with The Rabbi’s Notes download below the native paywall and in automatic paid/founding welcome emails. This pilot is configured; the article remains a draft. Do not revert that placement to an earlier paid-continuation pattern. No daily or weekly study-sheet cadence is promised. See `one-word-wiser/study-companion/delivery-2026-09-16.md`.
