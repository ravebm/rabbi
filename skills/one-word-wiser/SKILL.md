...
Open with first name + state and the verse they sent → the weekday anatomy keyed to the word the verse turns on, secret open → "Send me a verse. Just reply to this email." → "— Rabbi Evan". No footer: the week is not previewed, the reader meets Monday's word on Monday. Until reader verses arrive, Evan picks the verse (the one Christians ask a rabbi about most) and the post says so in one plain line at the top; the subject line stays `📖 Your verse: [reference]` (`samples/week-01-sunday.md`).
