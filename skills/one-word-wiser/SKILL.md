...
**Free half (300–400 words): the teaching.** Hebrew script large and centered → transliteration (stress in CAPS) + gloss → "say it" line → the picture, only if the word gives one honestly (a root picture is a device, not a requirement) → **one** verse (NIV, then "The word under '…' is *…*", then transliterated Hebrew with the word bolded) → the turn (2–4 short paragraphs, one idea: the teachable interpretation; this is the main body) → *one line to carry* in italic on its own line → **the door**: one or two sentences, italic lead-in "*The secret inside teshuvah:*", hinting at what the second half reveals and doing two jobs at once, a real human need and a deeper understanding of what God asks ("…why the rabbis say the one who comes back stands where the one who never left can't, and what God is actually asking of you tonight, which is smaller than sorry"). A secret and an insight, never a pitch. No "Today's question."
`` `[PAYWALL]` `` (weeks 1–2: delete the marker; the post runs whole)
**Paid half (200–250 words): the secret, and what God asks.** The secret, 120–180 words: one **hidden layer** of the word that passes the sod test in `02-daily-format.md`, told as a scene, source named in the text, one image the reader keeps (devices welcome, all the tradition's own and sourced; use the bank's secret unless you have a better one; if a day has no real secret, say so instead of shipping a paraphrase) → **what God asks** (40–80 words: the secret turned toward the reader's life and toward what God wants of us, in plain words, "you know the one"; this is where the door's need is met) → one thing to do (one sentence, tonight, offered not assigned) → *the line to sleep on* → the close ("Tomorrow: *next word*, gloss.") → "— Rabbi Evan" → optional `Audio (~1:30)` script.
